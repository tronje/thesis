...
2020.\footnote{\url{https://arstechnica.com/information-technology/2017/07/with-html5-webgl-javascript-ascendant-adobe-to-cease-flash-dev-at-end-of-2020/}}
...
In Section~\ref{section:data_properties} we alleged that a use of \textit{toDataURL}
suggests a high likelihood of canvas fingerprinting.
To show the plausibility of this claim, we have analysed the JavaScript served by
75 sites that use \textit{toDataURL} by hand.
These 75 sites were chosen from the list of sites which call \textit{toDataURL},
...
Following the analysis, we claim with confidence that 48 out of the 75 sites are fingerprinters.
...
\begin{tabular}{l  r r}
    ...
    \midrule
    Using a third-party fingerprinting script & & \\
    \todo{} & & \\
    \bottomrule
\end{tabular}
